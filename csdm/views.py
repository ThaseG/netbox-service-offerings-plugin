...
def _make_views(model, filterset_cls, filterset_form_cls, table_cls, form_cls, layout):
    ...
    # "ListView" entries.
    for view_cls, suffix in ((ListView, 'ListView'), (DetailView, 'View'), (EditView, 'EditView'),
...
PortfolioListView, PortfolioView, PortfolioEditView, PortfolioDeleteView = _make_views(
    Portfolio, filtersets.PortfolioFilterSet, forms.PortfolioFilterForm, tables.PortfolioTable, forms.PortfolioForm,
    layout=SimpleLayout(
...
ServiceListView, ServiceView, ServiceEditView, ServiceDeleteView = _make_views(
    Service, filtersets.ServiceFilterSet, forms.ServiceFilterForm, tables.ServiceTable, forms.ServiceForm,
    layout=SimpleLayout(
...
ServiceOfferingListView, ServiceOfferingView, ServiceOfferingEditView, ServiceOfferingDeleteView = _make_views(
    ServiceOffering, filtersets.ServiceOfferingFilterSet, forms.ServiceOfferingFilterForm,
    tables.ServiceOfferingTable, forms.ServiceOfferingForm,
    layout=SimpleLayout(
...
AppServiceListView, AppServiceView, AppServiceEditView, AppServiceDeleteView = _make_views(
    AppService, filtersets.AppServiceFilterSet, forms.AppServiceFilterForm, tables.AppServiceTable,
...
TechCIListView, TechCIView, TechCIEditView, TechCIDeleteView = _make_views(
    TechCI, filtersets.TechCIFilterSet, forms.TechCIFilterForm, tables.TechCITable, forms.TechCIForm,
    layout=SimpleLayout(
...
LifecycleListView, LifecycleView, LifecycleEditView, LifecycleDeleteView = _make_views(
    Lifecycle, filtersets.LifecycleFilterSet, forms.LifecycleFilterForm, tables.LifecycleTable, forms.LifecycleForm,
    layout=_lookup_layout(),
)
SLAListView, SLAView, SLAEditView, SLADeleteView = _make_views(
    SLA, filtersets.SLAFilterSet, forms.SLAFilterForm, tables.SLATable, forms.SLAForm,
...
OperationTimeListView, OperationTimeView, OperationTimeEditView, OperationTimeDeleteView = _make_views(
    OperationTime, filtersets.OperationTimeFilterSet, forms.OperationTimeFilterForm, tables.OperationTimeTable,
    forms.OperationTimeForm, layout=_lookup_layout(),
)
AvailabilityListView, AvailabilityView, AvailabilityEditView, AvailabilityDeleteView = _make_views(
    Availability, filtersets.AvailabilityFilterSet, forms.AvailabilityFilterForm, tables.AvailabilityTable,
    forms.AvailabilityForm, layout=_lookup_layout(),
)
CriticalityListView, CriticalityView, CriticalityEditView, CriticalityDeleteView = _make_views(
    Criticality, filtersets.CriticalityFilterSet, forms.CriticalityFilterForm, tables.CriticalityTable,
    forms.CriticalityForm, layout=_lookup_layout(),
)
EnvironmentListView, EnvironmentView, EnvironmentEditView, EnvironmentDeleteView = _make_views(
    Environment, filtersets.EnvironmentFilterSet, forms.EnvironmentFilterForm, tables.EnvironmentTable,
    forms.EnvironmentForm, layout=_lookup_layout(),
)
MTATListView, MTATView, MTATEditView, MTATDeleteView = _make_views(
    MTAT, filtersets.MTATFilterSet, forms.MTATFilterForm, tables.MTATTable, forms.MTATForm,
